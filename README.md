...
Se agrega un nuevo comando *ADDB* que permite agregar un *batch* de apuestas al servidor. El formato del comando es como sigue: `ADDB<CANTIDAD_DE_APUESTAS><AGENCIA>{APUESTA_1};{APUESTA_2};...;{APUESTA_N}`, donde `APUESTA_N = <LONGITUD_DE_APUESTA>${NOMBRE},${APELLIDO},${DOCUMENTO},${NACIMIENTO},${NUMERO}` para cualquier valor de `N` de la misma forma en que se enviaban las apuestas individuales.
